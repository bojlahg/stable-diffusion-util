...
def main():
    ...
    parser.add_argument(
        "--constseed",
        action='store_true',
        help="if enabled, uses constant seed",
    )
    parser.add_argument(
        "--ddim_eta",
        type=float,
    ...
    parser.add_argument(
        "--style_file",
        type=str,
        help="if specified, load styles from this file",
    )
    parser.add_argument(
        "--config",
        type=str,
    ...
    if opt.style_file:
        print(f"reading styles from {opt.style_file}")
        with open(opt.style_file, "r") as f:
                            ...
                            if not opt.skip_save:
                                for x_sample in x_samples_ddim:
                                    ...
                                    Image.fromarray(x_sample.astype(np.uint8)).save(
                                        os.path.join(sample_path, f"{filename}.png"))
